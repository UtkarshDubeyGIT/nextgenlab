        ...
        <motion.div>
          <div className="container mx-auto px-4 py-12 max-w-5xl">
            ...
            <motion.div
              ...
              className="text-start mb-16 mt-32"
            >
              <h1 className="text-5xl font-semibold bg-clip-text mb-4 ">
                Research & Publications
              </h1>
              <p className="text-xl text-gray-600 dark:text-gray-300 mx-auto">
                Discover our latest research contributions, scientific
                publications, and ongoing studies that push the boundaries of
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                        ...
                        <div className="flex-1 space-y-4">
                          ...
                          <div className="flex flex-wrap items-start gap-3">
                            <h2 className="text-xl font-semibold text-gray-900 dark:text-white leading-tight flex-1">
                              {publication.title}
                            </h2>
                            <Badge
                              className={`${
