    ...
    <div className="min-h-screen bg-neutral-50 flex flex-col justify-center">
      ...
      <div className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-semibold mb-4 sm:mb-6 px-2">
              About NextGen Lab
            </h1>
            <p className="text-base sm:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed px-2">
              ...
              boundaries of artificial intelligence, machine learning, and
      ...
      <section className="w-full max-w-5xl pb-12 sm:pb-20 flex justify-center">
        <div className=" mt-6 sm:mt-10 w-full rounded-xl mx-auto p-4 sm:p-6 border border-neutral-200 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0 justify-between items-center">
          <div className="p-2 sm:p-4 text-lg sm:text-xl md:text-2xl text-center font-sans w-full md:w-fit font-medium text-neutral-800">
            Meet The Team
          </div>
