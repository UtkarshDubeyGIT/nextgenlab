...
export function VortexDemo() {
  return (
    <div className="w-full mx-auto min-h-[60vh] md:h-screen overflow-visible">
      <Vortex
        backgroundColor="black"
        className="flex items-center flex-col justify-center px-2 md:px-10 py-4 w-full h-full"
      >
        <h2 className="text-white text-xl sm:text-2xl md:text-6xl font-bold text-center">
        Next Gen AI Lab 
        </h2>
        <p className="text-white text-xs sm:text-sm md:text-2xl max-w-xl mt-4 sm:mt-6 text-center">
