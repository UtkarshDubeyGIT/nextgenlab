...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full max-w-5xl bg-nuetral-50 dark:bg-neutral-950 font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto pt-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-5xl mb-4 text-black dark:text-white max-w-4xl font-bold font-sans">
          Our journey so far
        </h2>
